// Problem: C - Cookies and Greedy Takahashi
// Contest: AtCoder - AtCoder Beginner Contest 471
// URL: https://atcoder.jp/contests/abc471/tasks/abc471_c
...
void solve()
{
	...
	for (int i = 1; i < n; i++)
	{
		...
		{
			int dpre = a[cur] - a[cpre];
			int dnxt = a[cnxt] - a[cur];
			if (dpre <= dnxt) 
			{
				ans += (ll)dpre;
				remove(cur);
