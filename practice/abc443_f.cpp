// Problem: F - Non-Increasing Number
// Contest: AtCoder - Denso Create Programming Contest 2026（AtCoder Beginner Contest 443）
// URL: https://atcoder.jp/contests/abc443/tasks/abc443_f
...
void Solve()
{
	...
	if (!last) // some numbers ending in not 0 has also no solution, idk which
	{
		cout << -1 << endl;
		return;
	}
	pair <int, int> cur = {0, last};
	stack <int> ans;
